...
public class Auctioneer extends Agent {
    ...
    protected void setup() {       
        ...
        if (args != null && args.length > 0) {
            ...
            System.out.println("Auctioneer: Starting price is: " + itemPrice);
    ...
    private class AuctionPerformer extends Behaviour {
        ...
        public void action() {
            switch (step) {
                case 0:
                    // Reinitialise the expected proposals
                    ...
                    if (reply != null) {
                        ...
                        switch (reply.getPerformative()) {
                            case ACLMessage.PROPOSE:
                                ...
                                // Reinitialise if there are offers
                ...
                case 2:
                    ...
                    if (highestBidder != null) {
                        System.out.println("Highest bid at the moment: " + highestBid + " , bidder:  " + highestBidder.getName());
                    } else {
                ...
                case 3:
                    ...
                    System.out.println("Does anyone bid $" + String.valueOf(highestBid * 1.1) + "?");

                    if (roundsWithNoOffers != 0) {
                        System.out.println("The highest bid is "+highestBid + " for " + roundsWithNoOffers+" time");
                    }
                ...
                case 4:
                    ...
                    System.out.println("Item sold to: " + highestBidder.getName() + " for $" + highestBid);
                    step = 5;
                    break;
            }
        }
